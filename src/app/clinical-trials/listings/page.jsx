...
export default function Clinical() {
  ...
  if (searchValue && !active) {
    ...
    axios
      ...
      .then((response) => {
        ...
        setSearchTrails(response.data.response || []);
        console.log("Condition API Response:", response.data);
  ...
  if (!searchValue) return <p>Loading...</p>;
        ...
        <div className="inner_trailspage">
          ...
          <div className="main">
            ...
            <div className="filters_bar">
              <div className="flex items-center">Results for <span style={{cursor: 'pointer'}} className="resultsfor flex items-center">{searchValue.slice(0, 6)}  <svg
